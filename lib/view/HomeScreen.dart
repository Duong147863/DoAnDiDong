...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
   return Scaffold(
      ...
      title: InkWell(
        onTap: () {
        Navigator.push(       /* tạo chuyển động kéo qua chuyển đến Tìm kiếm*/                                                                                       
          context,
          PageRouteBuilder(
        ...
        if (totalCartQuantity > 0)
          Positioned(
            ...
            child: Container(
              ...
              child: Text('${totalCartQuantity.toString()}',style: const TextStyle(fontWeight: FontWeight.bold,color: Colors.black,),),
            ),
          ),
      ],
    ),
    ...
    child: Column(
      children: [
        ...
        Container(
            ...
            child:const Column(
              children: [
                Wrap(  // tạo danh mục sản phẩm
                  children: [
                    ProductContainer(
                      image: "assets/img/chao.png",
                      text: "Chảo",
                    ),
                    ProductContainer(
                      image: "assets/img/noi.png",
                      text: "Nồi",
                    ),
                    ProductContainer(
                      image: "assets/img/chen.jpg",
                      text: "Chén, bát",
                    ),
                    ProductContainer(
                    ...
                    ProductContainer(
                      image: "assets/img/manboc.png",
                      text: "Màng bọc",
                    ),
                    ProductContainer(
                      image: "assets/img/noicomdien.jpg",
                      text: "Nồi cơm điện",
                    ),
                    ProductContainer(
                      image: "assets/img/ruachen.png",
                      text: "Đồ rửa chén",
                    ),
                  ],
                ),
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: ListView.builder(
                      itemCount: (productData[selectedButtonIndex].length/2).ceil(),
                      itemBuilder: (context, index) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CategoryItem(name: text,), 
          ),
        );
      },
      child: Container(
